...
| [camel-jbossdatagrid-embedded] (camel-jbossdatagrid-embedded/README.md) | Infinispan, Camel, CDI, Rest | Demonstrates how camel-jbossdatagrid component can be made to work in an webapp run on EAP. |
